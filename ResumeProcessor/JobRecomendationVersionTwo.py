...
def main():
    ...
    resumeAsString = returnPdfResumeAsString(resumeRelativeFilePath)
    ...
    recommendedJobsFromFullPosting.to_csv("recommendedJobsFromFullPosting.csv")
    recommendedJobsFromJobTitle.to_csv("recommendedJobsFromJobTitle.csv")
    recommendedJobsFromShortJobDescription.to_csv("recommendedJobsFromShortJobDescription.csv")
    averageRecomendation.to_csv("receomendationV2.csv")
